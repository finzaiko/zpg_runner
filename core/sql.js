...
const sqlTriggers = (schemaTableName) => {
...
const sqlIndex = (schemaName, tableName) => {
  let whereTable = "";
  if (typeof tableName != "undefined") {
    exl = ` and tablename = ${tableName}`;
  }
...
const sqlTableContentByOid = (oid) => {
  let regClass = `
